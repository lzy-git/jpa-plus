package top.openyuan.ejpa.repository;

import top.openyuan.ejpa.constant.JpaConfigConstant;
...
public class SimpleJpaRepositoryExt<T, ID> extends SimpleJpaRepository<T, ID> implements JpaRepositoryExt<T, ID> {
