package top.openyuan.ejpa.specification.handler;

import org.hibernate.query.criteria.internal.CriteriaBuilderImpl;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import top.openyuan.ejpa.exception.BuildSpecificationException;
import top.openyuan.ejpa.specification.handler.bean.BetweenValue;
...
public abstract class AbstractPredicateHandler implements PredicateHandler {
    ...
    private void isValueComparable(Object value) {
        if (!(value instanceof Comparable)) {
            throw new BuildSpecificationException("【EJPA 异常】要比较的 value 值【" + value + "】不是可比较类型的，"
    ...
    protected boolean isAllowNull(Object annotation) {
        try {
            ...
            logger.error("【EJPA 错误提示】获取【@In】、【@OrIn】、【@NotIn】、【@OrNotIn】相关注解中的【allowNull】的值失败，将默认返回 false 的值.", e);
            return false;
        }
    }
    ...
    protected <Z, X> Predicate buildBetweenPredicate(
        ...
        if (value.getClass().isArray()) {
            ...
            throw new BuildSpecificationException("【EJPA 异常】构建【@Between】注解区间查询时，参数值类型不是数组或 "
    ...
    private <Z, X> Predicate buildBetweenPredicate(
        ...
        if (startValue != null && endValue != null) {
            ...
            throw new BuildSpecificationException("【EJPA 异常】构建【@Between】注解区间查询时，开始和结束的区间值均为【null】"
