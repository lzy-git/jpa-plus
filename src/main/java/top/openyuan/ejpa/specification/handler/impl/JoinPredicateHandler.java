...
import top.openyuan.ejpa.specification.FastSpecification;
...
public class JoinPredicateHandler extends AbstractPredicateHandler {
    ...
    @Override
    public Class<top.openyuan.ejpa.specification.annotation.Join> getAnnotation() {
        return top.openyuan.ejpa.specification.annotation.Join.class;
    }

    @Override
    public <Z, X> Predicate buildPredicate(
            CriteriaBuilder criteriaBuilder, From<Z, X> from, String name, Object value, Annotation annotation) {
        if (!(annotation instanceof top.openyuan.ejpa.specification.annotation.Join)) {
        ...
        Join<X, ?> subJoin = from.join(name,
                ((top.openyuan.ejpa.specification.annotation.Join) annotation).joinType());
