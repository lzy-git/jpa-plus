package top.openyuan.ejpa.specification;

import org.hibernate.internal.util.StringHelper;
import org.springframework.beans.BeanUtils;
import org.springframework.data.jpa.domain.Specification;
import top.openyuan.ejpa.config.FastConfig;
import top.openyuan.ejpa.exception.BuildSpecificationException;
import top.openyuan.ejpa.specification.handler.AbstractPredicateHandler;
import top.openyuan.ejpa.specification.handler.bean.Pair;
import top.openyuan.ejpa.specification.predicate.BooleanStaticPredicate;
import top.openyuan.ejpa.specification.predicate.FastPredicate;
import top.openyuan.ejpa.specification.predicate.FastPredicateBuilder;
import top.openyuan.ejpa.util.CollectionUtils;
import top.openyuan.ejpa.util.FieldUtils;
import top.openyuan.ejpa.util.StringUtils;
...
/**
 * ejpa 中构造 {@link Specification} 的核心 API 类.
 *
...
public final class FastSpecification {
    ...
    public static <Z, X> List<Predicate> beanParamToPredicate(
        ...
        Field[] fields = FieldUtils.getAllFields(beanParam.getClass());
